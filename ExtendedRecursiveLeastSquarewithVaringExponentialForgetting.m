function [ Guz, Gez ] = ExtendedRecursiveLeastSquarewithVaringExponentialForgetting ( u, y, na, nb, d, nc, Ts, Plot )
% this function is used to estimate the parameter of the system
% by using Extended RLS with Varing Exponential Forgetting  method
